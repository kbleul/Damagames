                                    ...
                                    {item && <>
                                        <section className="mt-2">
                                            ...
                                            <section className="w-4/5 ml-[5%] text-xs font-light">
                                                ...
                                                {/* {parseInt(user.coin) - item.price < 0 &&
                                                    <div className="text-white flex justify-between items-center mt-[3vh] border-t border-gray-700 py-2">
                                                        <p className="text-orange-color text-center text-xs mb-4 w-full">You can't affort this yet !</p>

                                                    </div>} */}
                                                {/* <p className="text-orange-color text-xs">Price = {pricePrompt} coins</p> */}
                                            </section>
