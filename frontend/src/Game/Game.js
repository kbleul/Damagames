...
console.log({newMoveState})
  ...
  return (
    ...
    >
      ...
      <button onClick={changeSound} className="ml-[5%] flex flex-col items-center justify-center">
      ...
      <p className="text-white font-bold">Timer : {timer}</p>
      
      {/* //<button className="text-white" >{soundOn ? "SoundOn" : "SoundOff"}</button> */}
        <button
          className="mr-8"
