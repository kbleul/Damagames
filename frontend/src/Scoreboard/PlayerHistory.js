...
const PlayerHistory = ( {playerName} ) => {
  ...
  return (<>{ Object.keys(history).length > 0 &&
    ...
    <section className="absolute top-8 w-full flex justify-center items-end text-white pt-3" >
        <div className='w-4/5 max-w-[600px] border border-gray-400 rounded-[2rem] pt-8 pb-12 flex flex-col items-center' style={{  background: `linear-gradient(120deg, rgb(39, 138, 134) 1%, rgba(11, 42, 43, 0.32) 10%, rgb(22, 85, 82) 98%) repeat scroll 0% 0%`
    }}>
