...
class StoreItemRequest extends FormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            'nameAm' => 'required',
            'history' => 'required_if:type,Avatar|array',
            'history.*.historyAmharic' => 'required',
            'history.*.historyEnglish' => 'required',
            'history.*.image' => 'nullable|',
            'price' => 'required|integer',
            'type' => 'required|in:Avatar,Crown,Board',
            'item' => 'required|mimes:png,jpeg,jpg,svg,gif,bmp,bmp,tiff,webp|max:5000',
